...
export class ProjectListComponent implements OnInit {
  ...
  openNewProjectDialog() {
    ...
    dialogRef.afterClosed().subscribe( result => {
      console.log(result);
      this.projects = [... this.projects, {id: 4, name: '一个新项目', desc: '这是一个新项目', coverImg: 'assets/covers/8.jpg'}],
      this.projects = [... this.projects, {id: 5, name: 'another新项目', desc: '这是a一个新项目', coverImg: 'assets/covers/9.jpg'}]      
    });
  }
  launchInviteDialog(){
